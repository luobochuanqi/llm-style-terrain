...
用法:
    ...
    # 512x512
    uv run python -m src.dataprocess.visualize_features --size 512
"""
...
def main():
    parser = argparse.ArgumentParser(description="可视化分析脚本")
    parser.add_argument(
        "--size",
        type=int,
        choices=[256, 512],
    ...
    visuals_dir = config.dataset_base / f"visuals_{args.size}"
